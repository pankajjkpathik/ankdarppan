...
const JanmashtamiBanner = () => (
  <section className="relative overflow-hidden border-b border-[rgba(200,154,62,0.4)] bg-[#061229]">
    ...
    <div className="absolute bottom-0 left-0 w-48 h-48 bg-[#E8792C]/10 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2" />
