...
import { ArrowLeft, Plus, Pencil, Trash2, Upload, Loader2, LogOut } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <form onSubmit={handleSubmit} className="glass-card p-6 space-y-4 mb-10">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <Label>Badge</Label>
              <Input name="badge" value={form.badge} onChange={handleChange} placeholder="e.g. Bestseller, New" className="bg-secondary/50 border-border" />
            </div>
            <div className="space-y-1.5">
              <Label>Price (₹) *</Label>
